...
<body>
    ...
    <label id="hamburger" for="abrir-cerrar"><div class="button"><div class="menu_button"></div><div class="menu_button"></div><div class="menu_button"></div></div></label>
 
    <div id="sidebar" class="sidebar">
        
        <div class="logo"><img src="../img/Logo-Extend.svg"></div>
        <ul class="menu select">
                ...
                <li ><a href="../views/Compras.jsp">Compras</a></li>
                <li ><a href="../views/ventas.jsp">Ventas</a></li>
            </ul>
    </div>
    <div id="contenido" >
        <div class="container-fluid">
            <div class="card">
                <h5>AGREGAR VENTAS</h5>
                <form class="row">
                    <div class="col-md-6">
                        <label for="clave" class="info_label">Clave de la Venta</label>
                        <input name="clavev" id="claveventa" placeholder="Ingresar..." type="text">
                    </div>
                    <div class="col-md-6">
                        <label for="examplePassword11" class="info_label">Clave del Cliente</label>
                        <input name="client" id="claveclient" placeholder="Ingresar..." type="text">
                    </div>
                    <div class="col-12">
